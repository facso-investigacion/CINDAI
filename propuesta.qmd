...
+----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Accesibles     | Considerando que la base contendrá información sensible sobre los investigadores y sus trayectorias académicas, **la base se mantendrá inicialmente en un repositorio privado**. Con el tiempo, se deberán acordar protocolos de acceso y uso.                   |
+----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Interoperables | La base de datos se almacenará en **formato valores separado por comas (.csv), con codificación UTF-8 y encabezados claros**.                                                                                                                                    |
+----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Reutilizable   | La base de datos vendrá acompañada de su **libro de códigos**.                                                                                                                                                                                                   |
|                |                                                                                                                                                                                                                                                                  |
|                | El control de versiones de la base de datos se realizará mediante **Git**. Las actualizaciones se llevaran a cabo periódicamente mediante pull request, los cuales serán revisados y aprobados por el equipo DIP antes de ser fusionados con la rama principal.  |
+----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

### Base de datos auxiliares

En segundo lugar, se propone construir bases auxiliares, cruzables de manera sencilla con la base principal. Estas bases incluyen.: información sobre académicos que se retiraron o abandonaron la Facultad; colaboración institucional; colaboración con académicos externos. 

La aplicación de los principios FAIR se realizará de la misma forma que con la base principal. 
